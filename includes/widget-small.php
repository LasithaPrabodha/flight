                    ...
                    <div class="booking_room">
                        ...
                        <div class="reservation">
                            <ul>
                                ...
                                <li class="span1_of_1 left economy">
                                    <h5>Class</h5>
                                    <!----------start section_room----------->
                            ...
                            <ul>
                                <li  class="span1_of_1">
                                    ...
                                    <div class="book_date">
                                            ...
                                            <input type="date" name="dep-date" id="datepicker" value="Select date" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Select date';}">
                                    </div>
                                </li>
